...
namespace YTech.SIS.GJCell.Web.Mvc.CastleWindsor
{
    ...
    public class ComponentRegistrar
    {
        ...
        private static void AddTasksTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("YTech.SIS.GJCell.Tasks")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("YTech.SIS.GJCell.Domain"));
        }
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container) 
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("YTech.SIS.GJCell.Infrastructure")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("YTech.SIS.GJCell.Domain"));
        }
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("YTech.SIS.GJCell.Web.Mvc")
                    .Pick()
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("YTech.SIS.GJCell.Tasks")
                    .Pick()
                    .WithService.FirstInterface());
        }
    }
