...
namespace YTech.SIS.GJCell.Tasks
{
    public class TWOTasks : ITWOTasks
    {
        ...
        public IEnumerable<Domain.TWOHaveRead> GetWOByDate(DateTime? dateFrom, DateTime? dateTo)
        {
            IEnumerable<Domain.TWOHaveRead> wos = this._woRepository.GetWOByDate(dateFrom, dateTo);
            return wos;
        }
        ...
        {
            IEnumerable<Domain.VWoByEmp> wos = this._woRepository.GetWoByEmp(dateFrom, dateTo);
            return wos;
        }
    }
}
